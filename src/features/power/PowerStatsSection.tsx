// src/features/power/PowerStatsSection.tsx
...
export const PowerStatsSection: React.FC = () => {
  ...
  const totalPoEBudget = tracts.reduce((sum, t) => sum + (t.totalPoEBudget || 0), 0);
  const usedPoE = tracts.reduce((sum, t) => sum + (t.usedPoE || 0), 0);
